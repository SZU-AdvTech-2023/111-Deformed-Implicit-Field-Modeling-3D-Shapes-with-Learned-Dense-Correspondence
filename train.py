...
p.add_argument('--shape_latent_dim', type=int,default=128, help='shape latent code dimension.')
p.add_argument('--config_latent_dim', type=int,default=128, help='config latent code dimension.')
...
p.add_argument('--num_categories', type=int,default=3, help='numbers of categories in the training set.')
